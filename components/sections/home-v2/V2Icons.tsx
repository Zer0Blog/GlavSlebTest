...
export const IconTelegramBrand = ({ size = 18, className = '', style }: SocialIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconWhatsAppBrand = ({ size = 18, className = '', style }: SocialIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconVKBrand = ({ size = 18, className = '', style }: SocialIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
