...
export default function ModernHomePageV2() {
  ...
  return (
<div className="modern-home modern-home-v2 min-h-screen">
      {/* ═══════════════════════════════════════
          MOBILE MENU
          ═══════════════════════════════════════ */}
      {menuOpen && (
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4">
            <a
              href="#contact"
              className="nav-cta-v2 hidden sm:block"
            >
              Связаться
            </a>
            <button
        ...
        <div className="w-full max-w-[1400px]">
          ...
          <div className="hero-fade relative w-full overflow-hidden rounded-3xl sm:rounded-[2rem]" style={{ aspectRatio: '21/9' }}>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 sm:p-12 md:p-16">
              ...
              <h1 className="hero-fade hero-fade-d2 font-display mb-6 text-3xl font-bold leading-tight tracking-wide sm:text-5xl md:text-6xl lg:text-7xl" style={{ color: '#F5F0EA' }}>
                ТЕРМОДРЕВЕСИНА<br />
                <span style={{ color: 'var(--accent-gold)' }}>ПРЕМИУМ-КАЧЕСТВА</span>
              </h1>
              <p className="hero-fade hero-fade-d3 mb-6 max-w-md text-[14px] leading-relaxed" style={{ color: 'rgba(245,240,234,0.65)' }}>
                Стабильность. Красота. Долговечность.<br />Термообработка для вашего проекта.
              </p>
              <div className="hero-fade hero-fade-d4 flex flex-wrap items-center gap-4 sm:gap-6">
                <a
                  href="#catalog"
                  className="btn-thermo-v2"
                >
                  Смотреть каталог
                </a>
                <a
      ...
      <section className="px-6 py-20 md:py-28" style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div className="mx-auto grid max-w-7xl gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div
            ...
            style={{ backgroundColor: 'var(--bg-card-v2)' }}
          >
            <h3 className="mb-5 text-[11px] font-semibold tracking-[0.1em] uppercase" style={{ color: 'var(--text-primary)' }}>
              Категории
            </h3>
              ...
              {CATEGORIES.map((cat) => (
                <li key={cat}>
                  <a
                    ...
                    style={{ borderBottom: '1px solid var(--border-strong)', color: 'var(--text-secondary)' }}
                    onMouseEnter={(e) => (e.currentTarget.style.color = 'var(--text-primary)')}
                    onMouseLeave={(e) => (e.currentTarget.style.color = 'var(--text-secondary)')}
                  >
                    <span className="text-[13px]">{cat}</span>
                    <ChevronRight className="opacity-[0.35]" />
                  </a>
                </li>
              ))}
            </ul>
          ...
          {/* Col 3 — Product hit */}
          <div
            className="reveal reveal-d2 overflow-hidden rounded-2xl t-transition"
            style={{ backgroundColor: 'var(--bg-card-v2)' }}
          >
            <img
            ...
            <div className="flex flex-col p-6">
              ...
              <div className="mt-3 text-[22px] font-bold" style={{ color: 'var(--text-primary)' }}>
                5 420 ₽&nbsp;/&nbsp;м²
              </div>
              <a
                href="#catalog"
                className="btn-thermo-v2 mt-4 w-full justify-center"
              >
                Подробнее
              </a>
            </div>
          ...
          <div
            ...
            style={{ backgroundColor: 'var(--bg-card-v2)' }}
          >
            <h3 className="mb-1 text-[11px] font-semibold tracking-[0.1em] uppercase" style={{ color: 'var(--text-primary)' }}>
            ...
            <form onSubmit={(e) => handleFormSubmit(e, 'consult')} className="flex flex-1 flex-col gap-3">
              ...
              <button
                type="submit"
                className="mt-auto btn-thermo-v2 w-full justify-center"
                style={{
          ...
          <div className="reveal mb-14 flex flex-col items-start justify-between gap-8 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="font-display text-4xl font-bold leading-tight md:text-5xl lg:text-6xl" style={{ color: 'var(--text-primary)' }}>
                Столы из<br />
                <span style={{ color: "var(--accent-gold)" }}>живого дерева</span>
              </h2>
            </div>
            {/* Filter tabs */}
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="reveal mb-16">
            ...
            <h2 className="font-display text-4xl font-bold leading-tight md:text-5xl lg:text-6xl" style={{ color: 'var(--text-primary)' }}>
              ...
              <span style={{ color: "var(--accent-gold)" }}>полного цикла</span>
            </h2>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="reveal mb-14 flex flex-col items-start justify-between gap-8 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="font-display text-4xl font-bold leading-tight md:text-5xl lg:text-6xl" style={{ color: 'var(--text-primary)' }}>
                Редкие породы<br />
                <span style={{ color: "var(--accent-gold)" }}>со всего мира</span>
              </h2>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="reveal mb-14 flex flex-col items-start justify-between gap-8 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="font-display text-4xl font-bold leading-tight md:text-5xl lg:text-6xl" style={{ color: 'var(--text-primary)' }}>
                Реализованные<br />
                <span style={{ color: "var(--accent-gold)" }}>проекты</span>
              </h2>
            </div>
            <a
              href="/works"
        ...
        <div className="mx-auto max-w-7xl">
          <div className="reveal mb-14 max-w-lg">
            ...
            <h2 className="font-display text-4xl font-bold leading-tight md:text-5xl" style={{ color: 'var(--text-primary)' }}>
              Что говорят<br />
              <span style={{ color: "var(--accent-gold)" }}>клиенты</span>
            </h2>
          </div>
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-16 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            <h2 className="font-display mb-6 text-4xl font-bold leading-tight md:text-5xl lg:text-6xl" style={{ color: '#fff' }}>
              Найдите свой<br />
              <span style={{ color: "var(--accent-gold)" }}>слэб</span>
            </h2>
